...
impl RgbaLinear {
    #[inline]
    pub fn lerp(a: Self, b: Self, t: f32) -> Self {
        Self(Vec4::lerp(a.0, b.0, t))
    }

    pub fn with_a(self: Self, a: f32) -> Self {
        Self(Vec4::new(self.0.x, self.0.y, self.0.z, a))
    }
    #[inline]
...
impl Rgb {
    ...
    #[inline]
    pub fn to_rgb_linear(self: Self) -> RgbLinear {
        RgbLinear(vec3(
